...
BEGIN
	...
	(IdContacto, Source, Continent, Country, City, Email, Title, FirstName, Surname, JobTitle, CompanyName, Address,
		PostalCode, TelephoneNo, MobileNo, Fax, Website, COOPStatusLead, CQRStatusLead, COOPStatusCity,
		CQRStatusCity, Comment)
	SELECT IdContacto, Source, Continent, Country, City, Email, Title, FirstName, Surname, JobTitle, CompanyName, Address,
		PostalCode, TelephoneNo, MobileNo, Fax, Website, COOPStatusLead, CQRStatusLead, COOPStatusCity,
		CQRStatusCity, Comment
