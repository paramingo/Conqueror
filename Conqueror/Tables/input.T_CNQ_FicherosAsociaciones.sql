CREATE TABLE [input].[T_CNQ_FicherosAsociaciones] (
    ...
    CONSTRAINT [FK_T_CNQ_FicherosAsociaciones_T_CNQ_FicherosRegistro] FOREIGN KEY ([IdFichero]) REFERENCES [input].[T_CNQ_FicherosRegistro] ([IdFichero])
);
...
GRANT INSERT
    ON OBJECT::[input].[T_CNQ_FicherosAsociaciones] TO [CNQ_SSISUser]
    AS [dbo];
